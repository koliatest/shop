...
@connect((state) => ({ user: state.auth.user,
  ...
  { attachInfo, logout, push }
)
@reduxForm({
  form: 'attachBank',
  fields: ['bankEmail', 'bankPassword'],
  validate: attachBankValidation
})
export default class AttachBankForm extends Component {
  static propTypes = {
                  ...
                  <div className="modal-footer">
                    ...
                    <button className="btn btn-success"
                            ...
                            onClick={handleSubmit(() => {
                              ...
                              this.props.attachInfo({...values, email: ''})
                                .then(() => {
